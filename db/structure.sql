...
--
-- Name: data fk_rails_321c36654f; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.data
    ADD CONSTRAINT fk_rails_321c36654f FOREIGN KEY (series_id) REFERENCES public.series(id);
